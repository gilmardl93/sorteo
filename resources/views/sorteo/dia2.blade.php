...
@section('content')
    <div class="note note-success">
        ...
        <p> Asignación de postulantes para el dia Miercoles 09 de Agosto del 2017.</p>
    </div>
    ...
    {!! Form::open(['url' => 'registrar-dia2','method' => 'POST']) !!}
    <div class="row">
        <div class="col-md-4">
...
<script>
    $(function(){
        $("#actualizar").on("click", function(){
            setTimeout(function(){ window.location="dia2"; },2500);
        });
    });
</script>
@stop